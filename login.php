...
.user-icon {
	top:168px; /* Positioning fix for slide-in, got lazy to think up of simpler method. */
...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <a href="
    ...
    <a href="
    admin.php"><button class="btn btn-primary navbar-btn">Admin</button></a>
...
<br>
<br>
<form name="login-form" class="login-form" action="check.php" method="post">
	
		<div class="header">
		<Center><h1>Welcome to libx </h1></Center>
		<h3><span>Please<b> login!!!</b></span></h3>
		</div>
	
		<div class="content">
		<input type="text" id="user_id" name="user_id" class="input user_id" placeholder="Username" / required>
		<div class="user-icon"></div>
		<input type="password" id="password" name="password" class="input password" placeholder="Password" / required>
		<div class="pass-icon"></div>	
         <input type="text" id="userid" name="userid" class="input password" placeholder="userid" / required>
		</div>

		<div class="footer">

		<input type="submit" id="btn" name="register" class="button" value="insert"/ href="book_issue.php">

		New member !!!! <a href="register.php"><b>Register here</b></a>
